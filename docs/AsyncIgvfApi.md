...
await api.report(**parameters) # Generate a report based on search query. All results are returned. 
```
...
await api.search(**parameters) # Search for items in the IGVF Project. 
```
