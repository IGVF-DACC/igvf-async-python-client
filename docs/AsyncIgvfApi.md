...
> MpraQualityMetricResults mpra_quality_metrics(query=query, limit=limit, sort=sort, id=id, aliases=aliases, analysis_step_version=analysis_step_version, award_id=award_id, award_component=award_component, creation_timestamp=creation_timestamp, description=description, fraction_assigned_oligos=fraction_assigned_oligos, lab_id=lab_id, lab_title=lab_title, median_assigned_barocdes=median_assigned_barocdes, median_barcodes_passing_filtering=median_barcodes_passing_filtering, median_rna_read_count=median_rna_read_count, notes=notes, pct_oligos_passing=pct_oligos_passing, pearson_correlation=pearson_correlation, quality_metric_of=quality_metric_of, release_timestamp=release_timestamp, status=status, submitted_by=submitted_by, submitter_comment=submitter_comment, summary=summary, uuid=uuid)
 ...
 **lab_id** | **List[str]**| Filter by lab.@id | [optional] 
 **lab_title** | **List[str]**| Filter by lab.title | [optional] 
 **median_assigned_barocdes** | **List[float]**| Filter by median_assigned_barocdes | [optional] 
 ...
 **notes** | **List[str]**| Filter by notes | [optional] 
 **pct_oligos_passing** | **List[float]**| Filter by pct_oligos_passing | [optional] 
