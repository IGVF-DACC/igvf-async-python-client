 ...
 **samples_construct_library_sets_small_scale_gene_list_status** | **List[str]**| Filter by samples.construct_library_sets.small_scale_gene_list.status | [optional] 
