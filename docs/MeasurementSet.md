...
**crispr_screen_readout** | **str** | The sequencing readout produced by this CRISPR measurement set. | [optional] 
**crispr_screen_biometric** | **str** | The phenotype used for selection or inference in this CRISPR screen, distinct from the sequencing readout. | [optional] 
...
**strand_specificity** | **str** | Indicates which strand of the original RNA molecule the transcriptomic library represents. &#39;5 prime to 3 prime&#39; (forward) libraries generate cDNA corresponding to the same strand as the RNA, while &#39;3 prime to 5 prime&#39; (reverse) libraries generate cDNA complementary to the RNA. This property is independent of the physical direction of sequencing reads. | [optional] 
...
**targeted_genes** | **List[str]** | A list of genes that are the primary focus of this assay. For example, TF ChIP-seq attempts to identify binding sites of a protein encoded by a specific gene. In CRISPR FACS screens where the assay investigates abundance or expression of a specific gene, list that gene here. When a gene is used only as a sort or differentiation marker and is not the primary focus of the experiment, use biomarkers.gene on the sample instead and omit targeted_genes. This property differs from small_scale_gene_list in Construct Library Set, which describes genes targeted by the content integrated in the constructs (such as guide RNAs). | [optional] 
**targeted_proteins** | **List[str]** | Immunoprecipitated protein targets or controls for chromatin binding assays, such as histone post-translational modifications profiled by Histone ChIP-seq or CUT&amp;RUN. | [optional] 
