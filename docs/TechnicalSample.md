...
**virtual** | **bool** | Virtual samples do not represent actual physical entities from experiments, but instead capture metadata about hypothetical or inferred samples relevant to reported analysis results. | [optional] 
...
**originated_from** | **str** | Links to a technical sample that was originated from due to the introduction of a genetic modification. | [optional] 
**id** | **str** |  | [optional] 
