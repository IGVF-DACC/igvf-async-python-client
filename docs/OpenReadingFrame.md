...
**transcript_ids** | **List[str]** | ENSEMBL TranscriptID of official nomenclature approved transcript/isoform of that gene | [optional] 
**barcode_sequence** | **str** | DNA sequence of the unique barcode identifier of the overexpressed construct | [optional] 
**orf_sequence** | **str** | DNA sequence of the ORF specifically (this is a subset of the Insert DNA sequence) | [optional] 
**insert_sequence** | **str** | DNA sequence of longer construct | [optional] 
