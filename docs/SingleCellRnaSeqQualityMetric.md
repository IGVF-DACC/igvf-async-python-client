...
**n_targets** | **float** |  | [optional] 
**n_bootstraps** | **float** |  | [optional] 
**n_processed** | **float** |  | [optional] 
**n_pseudoaligned** | **float** |  | [optional] 
**n_unique** | **float** |  | [optional] 
**p_pseudoaligned** | **float** |  | [optional] 
**p_unique** | **float** |  | [optional] 
**index_version** | **float** |  | [optional] 
**k_mer_length** | **float** |  | [optional] 
**id** | **str** |  | [optional] 
