...
class AnalysisSet(BaseModel):
    ...
    subset_samples: Optional[List[StrictStr]] = Field(default=None, description="The subset of sample(s) this analysis set represents, such as demultiplexed constituents or a timepoint from a differentiation series. Takes priority over samples inferred from input_file_sets when calculating samples and sample_summary.")
    ...
    sample_summary: Optional[StrictStr] = Field(default=None, description="A summary of the samples associated with input file sets of this analysis set.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sample_summary": obj.get("sample_summary"),
