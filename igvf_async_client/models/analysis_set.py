...
class AnalysisSet(BaseModel):
    ...
    demultiplexed_samples: Optional[List[StrictStr]] = Field(default=None, description="The sample(s) associated with this analysis set inferred through demultiplexing.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "demultiplexed_samples": obj.get("demultiplexed_samples"),
