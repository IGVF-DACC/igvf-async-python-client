...
class AnalysisSet(BaseModel):
    ...
    samples: Optional[List[StrictStr]] = Field(default=None, description="Samples associated with this analysis set.")
    ...
    subset_samples: Optional[List[StrictStr]] = Field(default=None, description="The subset of sample(s) this analysis set represents, such as demultiplexed constituents or a timepoint from a differentiation series. Takes priority over samples inferred from input_file_sets when calculating samples and simplified_sample_summary.")
    uniform_pipeline_status: Optional[StrictStr] = Field(default=None, description="The status of the single cell or Perturb-seq uniform pipeline processing for this analysis set, if applicable.")
    pipeline_parameters: Optional[List[StrictStr]] = Field(default=None, description="The document(s) or file(s) providing necessary configurations for reproducing the analysis.")
    ...
    preferred_assay_titles: Optional[List[StrictStr]] = Field(default=None, description="Preferred Assay Title(s) of assays that produced data analyzed in the analysis set.")
    ...
    simplified_sample_summary: Optional[StrictStr] = Field(default=None, description="A summary of the samples associated with input file sets of this analysis set.")
    functional_assay_mechanisms: Optional[List[StrictStr]] = Field(default=None, description="The biological processes measured by the functional assays.")
    ...
    targeted_genes: Optional[List[StrictStr]] = Field(default=None, description="A list of genes targeted by the input measurement sets assays.")
    targeted_proteins: Optional[List[StrictStr]] = Field(default=None, description="Immunoprecipitated protein targets or controls aggregated from the input measurement sets and analysis sets.")
    enrichment_designs: Optional[List[StrictStr]] = Field(default=None, description="The enrichment designs used by the inputs of this analysis set.")
    __properties: ClassVar[List[str]] = ["is_on_anvil", "doi", "preview_timestamp", "input_file_sets", "release_timestamp", "publications", "documents", "lab", "award", "accession", "alternate_accessions", "collections", "status", "revoke_detail", "schema_version", "uuid", "notes", "aliases", "creation_timestamp", "submitted_by", "submitter_comment", "description", "dbxrefs", "samples", "donors", "file_set_type", "supersedes", "external_image_data_url", "subset_samples", "uniform_pipeline_status", "pipeline_parameters", "@id", "@type", "summary", "files", "control_for", "superseded_by", "submitted_files_timestamp", "input_for", "construct_library_sets", "data_use_limitation_summaries", "controlled_access", "preferred_assay_titles", "preferred_assay_slims", "assay_titles", "assay_slims", "protocols", "simplified_sample_summary", "functional_assay_mechanisms", "workflows", "targeted_genes", "targeted_proteins", "enrichment_designs"]
    ...
    @field_validator('uniform_pipeline_status')
    def uniform_pipeline_status_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value

        if value not in set(['preprocessing', 'processing', 'error', 'completed']):
            raise ValueError("must be one of enum values ('preprocessing', 'processing', 'error', 'completed')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "subset_samples": obj.get("subset_samples"),
            "uniform_pipeline_status": obj.get("uniform_pipeline_status"),
            "pipeline_parameters": obj.get("pipeline_parameters"),
            "@id": obj.get("@id"),
            "@type": obj.get("@type"),
            ...
            "simplified_sample_summary": obj.get("simplified_sample_summary"),
