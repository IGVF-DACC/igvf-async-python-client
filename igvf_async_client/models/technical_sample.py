...
class TechnicalSample(BaseModel):
    ...
    treatments: Optional[List[StrictStr]] = Field(default=None, description="A list of treatments applied to the technical sample with the purpose of perturbation.")
    originated_from: Optional[StrictStr] = Field(default=None, description="Links to a technical sample that was originated from due to the introduction of a genetic modification.")
    ...
    __properties: ClassVar[List[str]] = ["is_on_anvil", "preview_timestamp", "release_timestamp", "publications", "url", "sources", "lot_id", "product_id", "documents", "lab", "award", "accession", "alternate_accessions", "collections", "status", "revoke_detail", "schema_version", "uuid", "notes", "aliases", "creation_timestamp", "submitted_by", "submitter_comment", "description", "starting_amount", "starting_amount_units", "dbxrefs", "date_obtained", "part_of", "sorted_from", "sorted_from_detail", "virtual", "construct_library_sets", "moi", "construct_delivery_methods", "time_post_library_delivery", "time_post_library_delivery_units", "protocols", "supersedes", "selection_conditions", "sample_material", "taxa", "sample_terms", "treatments", "originated_from", "@id", "@type", "summary", "file_sets", "multiplexed_in", "parts", "sorted_fractions", "origin_of", "institutional_certificates", "superseded_by", "classifications"]
