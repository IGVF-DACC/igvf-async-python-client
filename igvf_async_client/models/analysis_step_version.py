...
class AnalysisStepVersion(BaseModel):
    ...
    workflows: Optional[List[StrictStr]] = Field(default=None, description="The workflows that this analysis step version is a part of.")
    __properties: ClassVar[List[str]] = ["preview_timestamp", "release_timestamp", "status", "lab", "award", "schema_version", "uuid", "notes", "aliases", "creation_timestamp", "submitted_by", "submitter_comment", "description", "analysis_step", "software_versions", "@id", "@type", "summary", "workflows"]
