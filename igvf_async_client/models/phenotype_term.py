...
class PhenotypeTerm(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["preview_timestamp", "release_timestamp", "status", "schema_version", "uuid", "notes", "aliases", "creation_timestamp", "submitted_by", "submitter_comment", "description", "term_id", "term_name", "deprecated_ntr_terms", "is_a", "@id", "@type", "summary", "name", "definition", "comments", "synonyms", "ancestors", "ontology"]
    ...
    def term_id_validate_regular_expression(cls, value):
        ...
        if not re.match(r"^(DOID|EFO|HP|MONDO|OBA|NTR|GO|BAO):[0-9]{2,8}|OBA:VT[0-9]{2,8}|NCIT:C[0-9]{2,8}$", value):
            raise ValueError(r"must validate the regular expression /^(DOID|EFO|HP|MONDO|OBA|NTR|GO|BAO):[0-9]{2,8}|OBA:VT[0-9]{2,8}|NCIT:C[0-9]{2,8}$/")
        return value
