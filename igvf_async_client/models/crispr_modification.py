...
class CrisprModification(BaseModel):
    ...
    tagged_proteins: Optional[List[StrictStr]] = Field(default=None, description="The tagged proteins in which the Cas nuclease is fused to an antibody.")
    ...
    __properties: ClassVar[List[str]] = ["preview_timestamp", "release_timestamp", "sources", "lot_id", "product_id", "documents", "status", "lab", "award", "schema_version", "uuid", "notes", "aliases", "creation_timestamp", "submitted_by", "submitter_comment", "description", "activated", "activating_agent_term_id", "activating_agent_term_name", "modality", "tagged_proteins", "cas", "fused_domain", "cas_species", "@id", "@type", "summary", "biosamples_modified"]
    ...
    def fused_domain_validate_enum(cls, value):
        ...
        if value not in set(['2xVP64', '2xVP64-2A-Puro', '2xVP64-2A-Thy1.1', '3xVP64', 'ABE8e', 'ABE8.20', 'ANTI-FLAG', 'BE4', 'BE4max', 'eA3A', 'eA3A-T31A', 'eA3A-T44D-S45A', 'evoCDA', 'KOX1-KRAB', 'M-MLV RT (PE2)', 'PEmax-La', 'p300', 'p300-2A-PuroR', 'TdCBE', 'TdCGBE', 'TdDE', 'Tet1', 'VPH', 'VP64', 'VP64-p65-Rta (VPR)', 'ZIM3-KRAB', 'ZNF563KRAB']):
            raise ValueError("must be one of enum values ('2xVP64', '2xVP64-2A-Puro', '2xVP64-2A-Thy1.1', '3xVP64', 'ABE8e', 'ABE8.20', 'ANTI-FLAG', 'BE4', 'BE4max', 'eA3A', 'eA3A-T31A', 'eA3A-T44D-S45A', 'evoCDA', 'KOX1-KRAB', 'M-MLV RT (PE2)', 'PEmax-La', 'p300', 'p300-2A-PuroR', 'TdCBE', 'TdCGBE', 'TdDE', 'Tet1', 'VPH', 'VP64', 'VP64-p65-Rta (VPR)', 'ZIM3-KRAB', 'ZNF563KRAB')")
        return value
