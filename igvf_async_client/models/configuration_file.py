...
class ConfigurationFile(BaseModel):
    ...
    validate_onlist_files: Optional[StrictBool] = Field(default=None, description="Whether checkfiles will validate the onlist files.")
    __properties: ClassVar[List[str]] = ["anvil_url", "catalog_collections", "catalog_class", "catalog_notes", "preview_timestamp", "release_timestamp", "documents", "lab", "award", "accession", "alternate_accessions", "collections", "status", "revoke_detail", "schema_version", "uuid", "notes", "aliases", "creation_timestamp", "submitted_by", "submitter_comment", "description", "analysis_step_version", "content_md5sum", "content_type", "dbxrefs", "derived_from", "derived_manually", "file_format", "file_format_specifications", "file_set", "file_size", "md5sum", "submitted_file_name", "upload_status", "validation_error_detail", "checkfiles_version", "checkfiles_timestamp", "supersedes", "seqspec_of", "@id", "@type", "summary", "integrated_in", "input_file_for", "gene_list_for", "loci_list_for", "quality_metrics", "superseded_by", "assay_titles", "preferred_assay_titles", "preferred_assay_slims", "workflows", "href", "s3_uri", "upload_credentials", "validate_onlist_files"]
    ...
    def file_format_validate_enum(cls, value):
        ...
        if value not in set(['yaml', 'json', 'tsv']):
            raise ValueError("must be one of enum values ('yaml', 'json', 'tsv')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "validate_onlist_files": obj.get("validate_onlist_files")
        })
        return _obj
