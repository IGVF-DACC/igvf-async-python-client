...
class Gene(BaseModel):
    ...
    allele: Optional[StrictStr] = Field(default=None, description="The allele of the gene.")
    ...
    geneid_with_allele: Optional[StrictStr] = Field(default=None, description="The ENSEMBL GeneID concatenated with its allele info.")
    ...
    def allele_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "geneid_with_allele": obj.get("geneid_with_allele")
        })
