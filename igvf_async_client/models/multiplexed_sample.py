...
class MultiplexedSample(BaseModel):
    ...
    construct_delivery_methods: Optional[List[StrictStr]] = Field(default=None, description="The construct delivery methods of the samples included in this multiplexed sample.")
    ...
    demultiplexed_to: Optional[List[StrictStr]] = Field(default=None, description="The in vitro system samples this multiplexed sample has been demultiplexed into.")
    ...
    phenotypic_features: Optional[List[StrictStr]] = Field(default=None, description="The phenotypic features of the samples included in this multiplexed sample.")
    ...
    targeted_sample_terms: Optional[List[StrictStr]] = Field(default=None, description="The targeted sample terms of subsamples that are a part of this multiplexed sample.")
    __properties: ClassVar[List[str]] = ["is_on_anvil", "preview_timestamp", "release_timestamp", "publications", "url", "documents", "lab", "award", "accession", "alternate_accessions", "collections", "status", "revoke_detail", "schema_version", "uuid", "notes", "aliases", "creation_timestamp", "submitted_by", "submitter_comment", "description", "starting_amount", "starting_amount_units", "dbxrefs", "date_obtained", "part_of", "sorted_from", "sorted_from_detail", "virtual", "construct_library_sets", "moi", "construct_delivery_methods", "time_post_library_delivery", "time_post_library_delivery_units", "protocols", "supersedes", "selection_conditions", "multiplexed_samples", "multiplexing_methods", "cellular_sub_pool", "barcode_map", "@id", "@type", "summary", "file_sets", "multiplexed_in", "parts", "sorted_fractions", "origin_of", "institutional_certificates", "superseded_by", "demultiplexed_to", "sample_terms", "taxa", "phenotypic_features", "treatments", "modifications", "donors", "biomarkers", "sources", "classifications", "targeted_sample_terms"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "targeted_sample_terms": obj.get("targeted_sample_terms")
        })
        return _obj
