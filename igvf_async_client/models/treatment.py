...
class Treatment(BaseModel):
    ...
    def purpose_validate_enum(cls, value):
        ...
        if value not in set(['activation', 'acute stimulation', 'agonist', 'antagonist', 'chronic stimulation', 'control', 'de-differentiation', 'differentiation', 'perturbation', 'selection', 'stimulation']):
            raise ValueError("must be one of enum values ('activation', 'acute stimulation', 'agonist', 'antagonist', 'chronic stimulation', 'control', 'de-differentiation', 'differentiation', 'perturbation', 'selection', 'stimulation')")
        return value
    ...
    def treatment_type_validate_enum(cls, value):
        ...
        if value not in set(['chemical', 'protein', 'diet']):
            raise ValueError("must be one of enum values ('chemical', 'protein', 'diet')")
        return value
    ...
    def treatment_term_id_validate_regular_expression(cls, value):
        ...
        if not re.match(r"^((CHEBI:[0-9]{1,7})|(UniProtKB:[A-Z0-9]{6})|(NTR:[0-9]{2,8})|(NCIT:C[0-9]{2,8}))$", value):
            raise ValueError(r"must validate the regular expression /^((CHEBI:[0-9]{1,7})|(UniProtKB:[A-Z0-9]{6})|(NTR:[0-9]{2,8})|(NCIT:C[0-9]{2,8}))$/")
        return value
