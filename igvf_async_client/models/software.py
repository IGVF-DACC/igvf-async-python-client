...
class Software(BaseModel):
    ...
    name: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="Unique name of the software package; a version of the title without white spaces.")
    ...
    categories: Optional[List[StrictStr]] = Field(default=None, description="The general categories of this software.")
    ...
    __properties: ClassVar[List[str]] = ["preview_timestamp", "source_url", "release_timestamp", "publications", "lab", "award", "status", "schema_version", "uuid", "notes", "aliases", "creation_timestamp", "submitted_by", "submitter_comment", "description", "name", "title", "used_by", "categories", "@id", "@type", "summary", "versions"]
    ...
    def categories_validate_enum(cls, value):
        ...
        for i in value:
            if i not in set(['CRISPR Screens', 'General Bioinformatic Utilities', 'Genomic Annotations', 'Networks', 'Predictions', 'Reporter Assays', 'Single Cell Multiome']):
                raise ValueError("each list item must be one of ('CRISPR Screens', 'General Bioinformatic Utilities', 'Genomic Annotations', 'Networks', 'Predictions', 'Reporter Assays', 'Single Cell Multiome')")
        return value
