...
class ImageFile(BaseModel):
    ...
    imaging_platform: Optional[StrictStr] = Field(default=None, description="The measurement device used to produce imaging data.")
    ...
    def file_format_validate_enum(cls, value):
        ...
        if value not in set(['jpg', 'png', 'svg', 'tar']):
            raise ValueError("must be one of enum values ('jpg', 'png', 'svg', 'tar')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "imaging_platform": obj.get("imaging_platform"),
            "@id": obj.get("@id"),
            "@type": obj.get("@type"),
