...
class AuxiliarySet(BaseModel):
    ...
    hashtag_barcode_map: Optional[StrictStr] = Field(default=None, description="The link to the hashtag barcode mapping tabular file.")
    ...
    preferred_assay_titles: Optional[List[StrictStr]] = Field(default=None, description="The preferred assay titles of the measurement sets that used this auxiliary set.")
    ...
    crispr_screen_readout: Optional[StrictStr] = Field(default=None, description="For auxiliary sets linked to CRISPR screen measurement sets, equivalent to file set type.")
    ...
    __properties: ClassVar[List[str]] = ["is_on_anvil", "doi", "preview_timestamp", "release_timestamp", "publications", "documents", "lab", "award", "accession", "alternate_accessions", "collections", "status", "revoke_detail", "url", "schema_version", "uuid", "notes", "aliases", "creation_timestamp", "submitted_by", "submitter_comment", "description", "dbxrefs", "samples", "donors", "file_set_type", "supersedes", "hashtag_barcode_map", "@id", "@type", "summary", "files", "control_for", "superseded_by", "submitted_files_timestamp", "input_for", "construct_library_sets", "data_use_limitation_summaries", "controlled_access", "measurement_sets", "preferred_assay_titles", "preferred_assay_slims", "crispr_screen_readout", "assay_titles", "assay_slims"]
    ...
    def file_set_type_validate_enum(cls, value):
        ...
        if value not in set(['cell hashing barcode sequencing', 'cell sorting', 'circularized RNA barcode detection', 'full-length DNA sequencing', 'gRNA sequencing', 'lipid-conjugated oligo sequencing', 'MORF barcode sequencing', 'quantification DNA barcode sequencing']):
            raise ValueError("must be one of enum values ('cell hashing barcode sequencing', 'cell sorting', 'circularized RNA barcode detection', 'full-length DNA sequencing', 'gRNA sequencing', 'lipid-conjugated oligo sequencing', 'MORF barcode sequencing', 'quantification DNA barcode sequencing')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "hashtag_barcode_map": obj.get("hashtag_barcode_map"),
            "@id": obj.get("@id"),
            "@type": obj.get("@type"),
