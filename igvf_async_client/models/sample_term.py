...
class SampleTerm(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["preview_timestamp", "release_timestamp", "status", "schema_version", "uuid", "notes", "aliases", "creation_timestamp", "submitted_by", "submitter_comment", "description", "term_id", "term_name", "deprecated_ntr_terms", "is_a", "dbxrefs", "@id", "@type", "summary", "name", "definition", "comments", "synonyms", "ancestors", "ontology", "organ_slims", "cell_slims", "developmental_slims", "system_slims"]
    ...
    def term_id_validate_regular_expression(cls, value):
        ...
        if not re.match(r"^(UBERON|EFO|CL|CLO|NTR|PCL):[0-9]{2,8}$", value):
            raise ValueError(r"must validate the regular expression /^(UBERON|EFO|CL|CLO|NTR|PCL):[0-9]{2,8}$/")
        return value
