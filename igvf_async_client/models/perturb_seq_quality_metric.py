...
class PerturbSeqQualityMetric(BaseModel):
    ...
    frac_cells_with_guide: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Fraction of cells with at least one assigned guide.")
    avg_cells_per_guide: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Average number of cells assigned to each guide.")
    ...
    umi_median: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Median total gene UMIs per cell after filtering.")
    genes_median: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Median number of expressed genes per cell after filtering.")
    n_cells_with_guide: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Number of cells with at least one assigned guide.")
    n_cells_exactly_1_guide: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Number of cells with exactly one assigned guide.")
    guide_umi_mean: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Mean total guide UMIs per cell after filtering.")
    mean_percent_mitochondrial: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Mean percent mitochondrial UMIs per cell.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "frac_cells_with_guide": obj.get("frac_cells_with_guide"),
            "avg_cells_per_guide": obj.get("avg_cells_per_guide"),
            "moi": obj.get("moi"),
            "avg_umis_per_cell": obj.get("avg_umis_per_cell"),
            "total_guides": obj.get("total_guides"),
            "umi_median": obj.get("umi_median"),
            "genes_median": obj.get("genes_median"),
            "n_cells_with_guide": obj.get("n_cells_with_guide"),
            "n_cells_exactly_1_guide": obj.get("n_cells_exactly_1_guide"),
            "guide_umi_mean": obj.get("guide_umi_mean"),
            "mean_percent_mitochondrial": obj.get("mean_percent_mitochondrial"),
