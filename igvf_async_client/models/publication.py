...
class Publication(BaseModel):
    ...
    website_url: Optional[StrictStr] = Field(default=None, description="A link to an external interactive website hosting data and analytic tools associated with the publication.")
