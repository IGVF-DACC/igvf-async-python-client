...
class InVitroSystem(BaseModel):
    ...
    virtual: Optional[StrictBool] = Field(default=None, description="Virtual samples do not represent actual physical entities from experiments, but instead capture metadata about hypothetical or inferred samples relevant to reported analysis results.")
