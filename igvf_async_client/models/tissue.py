...
class Tissue(BaseModel):
    ...
    preservation_method: Optional[StrictStr] = Field(default=None, description="The method by which the tissue/organ was preserved: cryopreservation (slow-freeze) or flash-freezing.")
