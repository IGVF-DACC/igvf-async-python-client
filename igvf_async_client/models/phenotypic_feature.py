...
class PhenotypicFeature(BaseModel):
    ...
    quality: Optional[StrictStr] = Field(default=None, description="A quality assessment associated with the phenotypic feature, such as a categorical description.")
    ...
    __properties: ClassVar[List[str]] = ["preview_timestamp", "release_timestamp", "status", "lab", "award", "schema_version", "uuid", "notes", "aliases", "creation_timestamp", "submitted_by", "submitter_comment", "description", "feature", "quantity", "quantity_units", "quality", "observation_date", "@id", "@type", "summary"]
    ...
    def quantity_units_validate_enum(cls, value):
        ...
        if value not in set(['meter', 'micromole', 'nanogram', 'microgram', 'milligram', 'gram', 'kilogram', 'milli-International Unit per milliliter', 'picogram per milliliter', 'nanogram per milliliter', 'milligram per deciliter', 'UPDRS', 'MMSE', 'SLEDAI', 'ZT']):
            raise ValueError("must be one of enum values ('meter', 'micromole', 'nanogram', 'microgram', 'milligram', 'gram', 'kilogram', 'milli-International Unit per milliliter', 'picogram per milliliter', 'nanogram per milliliter', 'milligram per deciliter', 'UPDRS', 'MMSE', 'SLEDAI', 'ZT')")
        return value
    ...
    def quality_validate_enum(cls, value):
        ...
        if value not in set(['none', 'sparse', 'moderate', 'frequent', 'unknown', 'I', 'II', 'III', 'IV', 'V', 'VI', 'E2/E2', 'E2/E3', 'E2/E4', 'E3/E3', 'E3/E4', 'E4/E4']):
            raise ValueError("must be one of enum values ('none', 'sparse', 'moderate', 'frequent', 'unknown', 'I', 'II', 'III', 'IV', 'V', 'VI', 'E2/E2', 'E2/E3', 'E2/E4', 'E3/E3', 'E3/E4', 'E4/E4')")
        return value
