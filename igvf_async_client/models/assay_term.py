...
class AssayTerm(BaseModel):
    ...
    definition: Optional[StrictStr] = Field(default=None, description="Definition for the term that was recorded in an ontology.")
    comments: Optional[List[StrictStr]] = Field(default=None, description="Comment for the term that was recorded in an ontology.")
    ...
    __properties: ClassVar[List[str]] = ["preferred_assay_titles", "preview_timestamp", "release_timestamp", "status", "schema_version", "uuid", "notes", "aliases", "creation_timestamp", "submitted_by", "submitter_comment", "description", "term_id", "term_name", "deprecated_ntr_terms", "is_a", "@id", "@type", "summary", "name", "definition", "comments", "synonyms", "ancestors", "ontology", "assay_slims", "category_slims", "objective_slims"]
