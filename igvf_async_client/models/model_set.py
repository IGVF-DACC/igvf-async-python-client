...
class ModelSet(BaseModel):
    ...
    preferred_assay_titles: Optional[List[StrictStr]] = Field(default=None, description="The assay(s) that served as input tranining data for the derivation of this model set.")
    preview_timestamp: Optional[StrictStr] = Field(default=None, description="The date the object was previewed.")
    input_file_sets: Optional[List[StrictStr]] = Field(default=None, description="The file set(s) that served as input training data for the derivation of this model set.")
    ...
    assay_terms: Optional[List[StrictStr]] = Field(default=None, description="The assay terms used to produce data in this model set.")
    ...
    __properties: ClassVar[List[str]] = ["is_on_anvil", "doi", "preferred_assay_titles", "preview_timestamp", "input_file_sets", "release_timestamp", "publications", "documents", "lab", "award", "accession", "alternate_accessions", "collections", "status", "revoke_detail", "url", "schema_version", "uuid", "notes", "aliases", "creation_timestamp", "submitted_by", "submitter_comment", "description", "dbxrefs", "samples", "donors", "file_set_type", "supersedes", "model_name", "model_version", "prediction_objects", "assay_terms", "model_zoo_location", "assessed_genes", "external_input_data", "@id", "@type", "summary", "files", "control_for", "superseded_by", "submitted_files_timestamp", "input_for", "construct_library_sets", "data_use_limitation_summaries", "controlled_access", "assay_titles", "externally_hosted", "software_versions", "preferred_assay_slims"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "assay_terms": obj.get("assay_terms"),
