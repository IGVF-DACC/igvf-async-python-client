...
class MeasurementSet(BaseModel):
    ...
    primer_designs: Optional[List[StrictStr]] = Field(default=None, description="The primer designs used in this measurement set.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "primer_designs": obj.get("primer_designs"),
