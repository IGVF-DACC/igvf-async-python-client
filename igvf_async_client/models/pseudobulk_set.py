...
class PseudobulkSet(BaseModel):
    ...
    """ # noqa: E501
    cell_type: Optional[StrictStr] = Field(default=None, description="The ontology term that describes the cell type of the cells in this pseudobulk and/or pseudobulk-derived prediction.")
    cell_qualifier: Optional[StrictStr] = Field(default=None, description="A qualifier that provides additional detail about the cell type annotation or the parent sample.")
    ...
    donors: Optional[List[StrictStr]] = Field(default=None, description="The donors of the samples associated with this pseudobulk set.")
    ...
    merged: Optional[StrictBool] = Field(default=None, description="Indicates if the pseudobulk set has been merged from other pseudobulk sets.")
    ...
    __properties: ClassVar[List[str]] = ["cell_type", "cell_qualifier", "is_on_anvil", "doi", "input_file_sets", "release_timestamp", "publications", "documents", "lab", "award", "accession", "alternate_accessions", "collections", "status", "revoke_detail", "url", "schema_version", "uuid", "notes", "aliases", "creation_timestamp", "submitted_by", "submitter_comment", "description", "dbxrefs", "samples", "donors", "file_set_type", "supersedes", "merged", "@id", "@type", "summary", "files", "control_for", "superseded_by", "submitted_files_timestamp", "input_for", "construct_library_sets", "data_use_limitation_summaries", "controlled_access", "cell_annotation", "workflows", "preferred_assay_titles", "preferred_assay_slims", "assay_titles", "assay_slims"]
