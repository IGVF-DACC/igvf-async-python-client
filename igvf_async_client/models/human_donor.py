...
class HumanDonor(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["is_on_anvil", "preview_timestamp", "release_timestamp", "taxa", "publications", "url", "documents", "lab", "award", "accession", "alternate_accessions", "collections", "status", "revoke_detail", "schema_version", "uuid", "notes", "aliases", "creation_timestamp", "submitted_by", "submitter_comment", "description", "dbxrefs", "sex", "virtual", "supersedes", "related_donors", "ethnicities", "human_donor_identifiers", "@id", "@type", "summary", "superseded_by"]
