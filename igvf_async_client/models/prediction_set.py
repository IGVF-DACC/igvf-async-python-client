...
class PredictionSet(BaseModel):
    ...
    """ # noqa: E501
    cell_type: Optional[StrictStr] = Field(default=None, description="The ontology term that describes the cell type of the cells in predictions derived from single cell pseudobulks. Other non-pseudobulk based predictions should not specify this property.")
    cell_qualifier: Optional[StrictStr] = Field(default=None, description="A qualifier that provides additional detail about the cell type annotation in predictions derived from single cell pseudobulks. Other non-pseudobulk based predictions should not specify this property.")
