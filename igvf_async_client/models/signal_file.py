...
class SignalFile(BaseModel):
    ...
    def file_format_validate_enum(cls, value):
        ...
        if value not in set(['bigWig', 'npz', 'tar']):
            raise ValueError("must be one of enum values ('bigWig', 'npz', 'tar')")
        return value
