...
class InstitutionalCertificate(BaseModel):
    ...
    data_use_limitation: Optional[StrictStr] = Field(default=None, description="Code indicating the limitations on data use for data generated from the applicable samples.")
    data_use_limitation_modifiers: Optional[List[StrictStr]] = Field(default=None, description="Code indicating a modifier on the limitations on data use for data generated from the applicable samples.")
    ...
    partner_labs: Optional[List[StrictStr]] = Field(default=None, description="Labs which belong to same institution as the signing PI and can share this institutional certificate.")
    partner_awards: Optional[List[StrictStr]] = Field(default=None, description="Awards granted to at least one lab that belongs to same institution as the signing PI and can share this institutional certificate.")
    id: Optional[StrictStr] = Field(default=None, alias="@id")
    type: Optional[List[StrictStr]] = Field(default=None, alias="@type")
    summary: Optional[StrictStr] = Field(default=None, description="A summary of the institutional certificate.")
    data_use_limitation_summary: Optional[StrictStr] = Field(default=None, description="A combination of the data use limitation and its modifiers")
    __properties: ClassVar[List[str]] = ["preview_timestamp", "release_timestamp", "status", "lab", "award", "schema_version", "uuid", "notes", "aliases", "creation_timestamp", "submitted_by", "submitter_comment", "description", "certificate_identifier", "controlled_access", "data_use_limitation", "data_use_limitation_modifiers", "samples", "urls", "partner_labs", "partner_awards", "@id", "@type", "summary", "data_use_limitation_summary"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "urls": obj.get("urls"),
            "partner_labs": obj.get("partner_labs"),
            "partner_awards": obj.get("partner_awards"),
            "@id": obj.get("@id"),
            "@type": obj.get("@type"),
            "summary": obj.get("summary"),
            "data_use_limitation_summary": obj.get("data_use_limitation_summary")
        })
        return _obj
