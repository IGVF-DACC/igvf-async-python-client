...
class CuratedSet(BaseModel):
    ...
    assay_term: Optional[StrictStr] = Field(default=None, description="The assay used to produce data in this curated set.")
    ...
    versions: Optional[List[StrictStr]] = Field(default=None, description="The versions of the reference files for external data loaded into the IGVF catalog.")
    ...
    __properties: ClassVar[List[str]] = ["is_on_anvil", "preferred_assay_titles", "preview_timestamp", "release_timestamp", "taxa", "publications", "documents", "lab", "award", "accession", "alternate_accessions", "collections", "status", "revoke_detail", "url", "schema_version", "uuid", "notes", "aliases", "creation_timestamp", "submitted_by", "submitter_comment", "description", "dbxrefs", "samples", "donors", "file_set_type", "supersedes", "assay_term", "@id", "@type", "summary", "files", "control_for", "superseded_by", "submitted_files_timestamp", "input_for", "construct_library_sets", "data_use_limitation_summaries", "controlled_access", "assay_titles", "assemblies", "transcriptome_annotations", "versions", "preferred_assay_slims"]
    ...
    def file_set_type_validate_enum(cls, value):
        ...
        if value not in set(['barcodes', 'editing templates', 'elements', 'external data for catalog', 'external sequencing data', 'functional effect', 'genome', 'genes', 'guide RNAs', 'pathway gene mapping', 'pipeline parameters', 'enrichment designs', 'QTL', 'training data for predictive models', 'transcriptome', 'variants']):
            raise ValueError("must be one of enum values ('barcodes', 'editing templates', 'elements', 'external data for catalog', 'external sequencing data', 'functional effect', 'genome', 'genes', 'guide RNAs', 'pathway gene mapping', 'pipeline parameters', 'enrichment designs', 'QTL', 'training data for predictive models', 'transcriptome', 'variants')")
        return value
