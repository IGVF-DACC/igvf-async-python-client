...
class Document(BaseModel):
    ...
    def document_type_validate_enum(cls, value):
        ...
        if value not in set(['cell fate change protocol', 'cell marker file', 'characterization', 'computational protocol', 'donor characteristics', 'experimental protocol', 'file format specification', 'image', 'library structure seqspec', 'model source data', 'ontology term reference', 'pipeline log', 'pipeline parameters', 'plate map', 'plasmid map', 'plasmid sequence', 'quality control report', 'standards', 'tile coordinates']):
