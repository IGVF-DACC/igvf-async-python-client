...
class PlatformTerm(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["preview_timestamp", "release_timestamp", "status", "schema_version", "uuid", "notes", "aliases", "creation_timestamp", "submitted_by", "submitter_comment", "description", "term_id", "term_name", "deprecated_ntr_terms", "is_a", "company", "sequencing_kits", "@id", "@type", "summary", "name", "definition", "comments", "synonyms", "ancestors", "ontology"]
    ...
    def company_validate_enum(cls, value):
        ...
        if value not in set(['10X Genomics', 'Element Biosciences', 'Illumina', 'Life Technologies', 'Oxford Nanopore Technologies', 'Pacific Biosciences', 'Parse Biosciences', 'Roche', 'Singular Genomics', 'Ultima Genomics']):
            raise ValueError("must be one of enum values ('10X Genomics', 'Element Biosciences', 'Illumina', 'Life Technologies', 'Oxford Nanopore Technologies', 'Pacific Biosciences', 'Parse Biosciences', 'Roche', 'Singular Genomics', 'Ultima Genomics')")
        return value
