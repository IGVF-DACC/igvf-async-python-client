...
class SequenceFile(BaseModel):
    ...
    tile: Optional[Annotated[int, Field(strict=True, ge=1)]] = Field(default=None, description="An integer identifying the tile of a gene of interest.")
    ...
    seqspec_document: Optional[StrictStr] = Field(default=None, description="A seqspec document describing the library and read structure.")
    ...
    read_names: Optional[List[StrictStr]] = Field(default=None, description="The read names of a sequence file based on how it will be used by uniform pipelines.")
    ...
    __properties: ClassVar[List[str]] = ["anvil_url", "base_modifications", "preview_timestamp", "externally_hosted", "external_host_url", "controlled_access", "release_timestamp", "documents", "lab", "award", "accession", "alternate_accessions", "collections", "status", "revoke_detail", "schema_version", "uuid", "notes", "aliases", "creation_timestamp", "submitted_by", "submitter_comment", "description", "analysis_step_version", "content_md5sum", "content_type", "dbxrefs", "derived_from", "derived_manually", "file_format", "file_format_specifications", "file_set", "file_size", "md5sum", "submitted_file_name", "upload_status", "validation_error_detail", "checkfiles_version", "checkfiles_timestamp", "supersedes", "flowcell_id", "lane", "tile", "read_count", "minimum_read_length", "maximum_read_length", "mean_read_length", "seqspec_document", "sequencing_platform", "sequencing_kit", "sequencing_run", "illumina_read_type", "index", "read_names", "@id", "@type", "summary", "integrated_in", "input_file_for", "gene_list_for", "loci_list_for", "quality_metrics", "superseded_by", "assay_titles", "preferred_assay_titles", "preferred_assay_slims", "workflows", "href", "s3_uri", "upload_credentials", "seqspecs"]
    ...
    @field_validator('read_names')
    def read_names_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value

        for i in value:
            if i not in set(['Read 1', 'Read 2', 'Barcode index', 'Barcode forward', 'UMI', 'Barcode reverse']):
                raise ValueError("each list item must be one of ('Read 1', 'Read 2', 'Barcode index', 'Barcode forward', 'UMI', 'Barcode reverse')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "seqspec_document": obj.get("seqspec_document"),
