...
class Locus(BaseModel):
    ...
    name: Optional[StrictStr] = Field(default=None, description="A human-readable name or identifier for the locus.")
    ...
    __properties: ClassVar[List[str]] = ["start", "name", "end", "chromosome", "assembly"]
