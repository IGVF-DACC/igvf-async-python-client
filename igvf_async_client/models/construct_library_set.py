...
"""
    ...
    The version of the OpenAPI document: 104.0.0
...
class ConstructLibrarySet(BaseModel):
    ...
    is_on_anvil: Optional[StrictBool] = Field(default=None, description="Indicates whether this file set has been submitted to AnVIL.")
