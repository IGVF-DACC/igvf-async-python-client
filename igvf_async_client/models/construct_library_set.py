...
class ConstructLibrarySet(BaseModel):
    ...
    small_scale_gene_list: Optional[List[StrictStr]] = Field(default=None, description="The specific, small scale list of (<=100) gene(s) this construct library was designed to target. This property differs from targeted_genes in Measurement Set, which describes genes that are the primary focus of an assay, and from biomarkers.gene on Sample, which describes genes used only as sort or differentiation markers.")
    ...
    small_scale_orf_list: Optional[List[StrictStr]] = Field(default=None, description="The specific, small scale list of (<=500) Open Reading Frame this construct library was designed to target.")
    large_scale_orf_list: Optional[StrictStr] = Field(default=None, description="The large scale list of (>100 ORF) this construct library was designed to target.")
    ...
    chromosomes: Optional[List[Annotated[str, Field(strict=True)]]] = Field(default=None, description="The list of chromosomes this construct library was designed to target.")
    ...
    def file_set_type_validate_enum(cls, value):
        ...
        if value not in set(['guide library', 'reporter library', 'expression vector library', 'overexpression vector library', 'editing template library']):
            raise ValueError("must be one of enum values ('guide library', 'reporter library', 'expression vector library', 'overexpression vector library', 'editing template library')")
        return value
    ...
    def scope_validate_enum(cls, value):
        ...
        if value not in set(['tile', 'exon', 'genes', 'loci', 'genome-wide', 'interactors', 'alleles', 'targeton', 'chromosome', 'control']):
            raise ValueError("must be one of enum values ('tile', 'exon', 'genes', 'loci', 'genome-wide', 'interactors', 'alleles', 'targeton', 'chromosome', 'control')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "small_scale_orf_list": obj.get("small_scale_orf_list"),
            "large_scale_orf_list": obj.get("large_scale_orf_list"),
            "exon": obj.get("exon"),
