...
class ATACFragmentSummaryStats(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["download", "href", "type", "size", "md5sum", "width", "height"]
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['text/csv', 'text/tab-separated-values']):
            raise ValueError("must be one of enum values ('text/csv', 'text/tab-separated-values')")
        return value
